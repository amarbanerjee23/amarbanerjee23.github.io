(() => {
  ['/assets/css/ux-calm-v2.css?v=20260822-contrast5'].forEach(href => {
  ...
  */
  if (body.classList.contains('academic-future-home') || body.classList.contains('academic-programs-page')) {
    import('/assets/js/story-unfold.js?v=20260822-contrast5').catch(error => console.error('Story support failed to load', error));
    return;
  }
